...
**CSV Format:**
```
EventID,Description,Threat,Score,Category,Indicators
4625,Failed Login Attempt,Brute Force Attack,7,Credential Access,"Multiple rapid failures; Dictionary attack patterns"
```
